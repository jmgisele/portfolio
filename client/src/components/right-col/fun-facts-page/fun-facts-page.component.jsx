...
export const FunPage = () => (
    <NavAnimation>
            <div id="fun-wrapper">
                ...
                <ul>
                    <li>
                        I grow a lot of my own herbs and make plant medicine (think elderberry syrup)
                        for friends & various mutual aid projects.
                    </li>
                    <li>
                        In the past, I've worked at a vegetable farm, a public library, and
                        an astrophysics lab. Perhaps more surprisingly, I enjoyed all three!
                    </li>
                    <li>
                        I'm originally from Oregon, but I've lived in every major bioregion of the continental US except for the Southwest. Maybe sometime soon?
                    </li>
                    <li>
