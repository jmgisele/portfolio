...
export const SkillsPage = () => (
  <NavAnimation id="skills-nav-container">
    <div id="skills-title-box">
      ...
      <h5 id="skills-subtitle">
        Don't see your stack? I'm always looking to pick up something new....
      </h5>
    </div>
    <section id="flex-skills-container">
      <SkillCard
        title="Langauages, Frameworks, Libraries"
        items={[
          "React/Next.js",
          "Svelte",
          "Flask",
      ...
      <SkillCard
        title="Styling"
        items={["SCSS", "Bootstrap", "MUI/Chakra", "Figma"]}
      />
      <SkillCard
        title="Databases"
